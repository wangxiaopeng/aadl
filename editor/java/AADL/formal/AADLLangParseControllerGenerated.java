...
public class AADLLangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("AADLLang");
  ...
  { 
    AADLLangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = AADLLangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = AADLLangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(AADLLangParseControllerGenerated.class);
    }
  ...
  { 
    return AADLLangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
